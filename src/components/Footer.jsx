        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Building innovative solutions with Salesforce and Machine
              Learning. Specializing in Salesforce development, automation, and
              custom solutions, alongside designing intelligent systems that
              leverage AI and ML to drive business efficiency and
              transformation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Indore (M.P.), India - 452001</li>
